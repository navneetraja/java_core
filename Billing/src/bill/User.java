				...
				while(true)
				{
					...
					switch(ch)
					{
					  ...
					  case 2:try {
						  			...
						  			do {
									  	...
									  	if(rs.next())
									  	{
									  		...
									  		if(item_qty>=qty&&qty>0)
									  		{
									  			...
									  			int u_qty=item_qty-qty;
									  			String sql1 = "UPDATE stock SET item_stock='"+ u_qty +"' WHERE item_name='"+item_name+"'";
						  			...
						  			System.out.println("To Order another item \nYES: Press 1 \\nNO: Press 2");
						  				ct=sc.nextInt();
			    	            	...
			    	            	stmt = conn.createStatement();
			    	            	String sql3="Select id from transactions where cust_name='"+name+"'";
			    	            	...
			    	            	{	
			    	            		 ...
			    	            		 System.out.println(list.get(counter)+"\t\t"+Qty.get(counter)+"\t\t"+t_amt.get(counter));  
			    	            		 
			    	            		 String sql4 = "INSERT INTO total_transaction(item_name,quantity,total,t_id) VALUES ('"+list.get(counter) +"','"+Qty.get(counter)+"','"+t_amt.get(counter)+"','"+id+"')";
